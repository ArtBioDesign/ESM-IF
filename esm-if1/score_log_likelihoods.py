...
def main():
    ...
    import get_mute_fasta
    import os
    import os.path
    output_fasta_file = os.path.join( os.path.dirname( args.outpath ),   "mute.fasta" ) 
    get_mute_fasta.main( args.pdbfile, args.chain, args.mute_csv, output_fasta_file )

    args.seqfile = output_fasta_file
